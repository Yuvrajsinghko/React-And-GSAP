const Navbar = () => {
  return (
    <div className="fixed flex justify-around items-center w-full h-20 top-0 left-0 z-20 px-60 font-bold text-[1.1vw] bg-[#F6F6EB] text-[#381fd1]">
      <div className="nav-left flex gap-10 items-center">
        ...
        <button className="uppercase hover:border-2 rounded-xl p-1">Use Cases</button>
        <button className="uppercase hover:border-2 rounded-xl p-1">Pricing</button>
        <button className="uppercase hover:border-2 rounded-xl p-1">Support</button>
        <button className="uppercase hover:border-2 rounded-xl p-1">Resources</button>
      </div>
      <div className="nav-right flex gap-5">
        <button className="uppercase hover:border-2 rounded-xl p-1">Log In</button>
        <button className="uppercase bg-[#381fd1] text-[#ffffff] rounded-xl border-none py-1 px-2">Request Demo</button>
      </div>
    </div>
  );
};

...
const LandingPage = () => {
  return (
    <div className="w-full h-screen bg-zinc-900 pt-1">
          ...
          return (
            <div className="masker">
              <div className="w-fit flex items-center">
                ...
                <h1 className='uppercase leading-[7vw]  text-[8vw] font-["TestFoundersGroteskX-Condensed"] font-bold'>
                  {item}
                </h1>
              </div>
            </div>
      ...
      <div className="border-t-[1px] border-zinc-700 mt-32 flex justify-between items-center py-7 px-20">
        {[

...
function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-900 p-20 flex gap-10 font-bold">
      <div className="w-1/2 h-full  flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[7vw] uppercase leading-none -mb-7">Eye-</h1>
          <h1 className="text-[7vw] uppercase leading-none -mb-7">Opening</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2 ">
        <div className="heading">
          <h1 className="text-[6vw] uppercase leading-none -mb-4">
            Presentations
          </h1>
          <div className="dets font-['NeueMontreal'] mt-10 ">
            <a className="block text-2xl " href="#">Facebook</a>
            <a className="block text-2xl " href="#">Instragram</a>
            <a className="block text-2xl " href="#">Twitter</a>
          </div>
        </div>
      </div>
    </div>
